...
- DeepSeek V4 Flash 0731 model weights are not included. The pinned model
  revision is `9e165c30e2704aec5d9d593cce3eebd58bbef1cb` and remains governed by
  DeepSeek's model terms.
